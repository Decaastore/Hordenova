...
export const en = {
  ...
  towerInfo: {
    ...
    masteryPrestigeNote: "Small, growing bonuses to range, efficiency, resistance and more — plus Respec Tokens and cosmetics.",
    masteryNextToken: "{levels} level(s) to next Respec Token",
    ...
    specializationRespec: "RESPEC PATH ({tokens} token(s) available)",
    skinSection: "SKIN",
    skinDefault: "Default",
  ...
  wiki: {
    ...
    masteryHint: "Uncapped Gems sink past Level 30 — permanent prestige. Never grants damage, attack speed, or range: it unlocks Specialization Respec Tokens and cosmetic-only visual tiers. Permanent across Seasons.",
    masteryRespecTokens: "Respec Tokens earned",
